module.exports = {
  siteMetadata: {
    ...
    description: `Seja muito bem vindo(a) ao meu novo blog! Aqui eu vou compartilhar um pouco do conhecimento adquirido na minha jornada como desenvolvedor Front End!`,
